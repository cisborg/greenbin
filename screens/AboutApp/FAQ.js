...
const FAQScreen = () => {
  ...
  const renderFAQDescription = (index) => {
    const answers = {
      ...
      Greenpoints: [
        ...
        "You can earn Greenpoints by making sustainable purchaes,donate and participating in events.",
        "Yes, you can convert Greenpoints to cash through the app's withdrawal section.",
        "Greenpoints expire after one 2 months of inactivity on your account.",
        "Yes, you can transfer Greenpoints to another user through the app by going to send points .",
        "To redeem Greenpoints, go to GCPs section and select your desired offer.",
        "Yes, there is a little fees on transaction for using Greenpoints.",
        "You can earn Greenpoints by referring friends who sign up for the app.",
        "You can use Greenpoints for discounts on eco-friendly products and services even outside the app!",
        "You can check your Greenpoints balance in your profile settings."
      ],
     
      'Bundle Packages': [
        "Bundle packages are pre-defined data plans offered at discounted rates.",
        "You can subscribe to bundle packages in the app under 'Bundle Packages'.",
        "Yes, you can customize your bundle package based on your needs.",
        "Yes, we offer discounts for long-term bundle subscriptions.",
      ...
      'GCP Calculator': [
        ...
        "GCP calculator logs output percentage threshold of average activities , donations and no of purchases and generates leaderboard.",
        "The GCP calculator uses algorithms based on your activities, donations and logs of purchases to provide an estimate.",
        "Yes, the GCP calculations are stored in bar-graph annually for future reference.",
      ...
      'App Features': [
        "The app offers features like data tracking, rewards, and community engagement.",
        "You can navigate the app using the bottom menu and the side navigation bar.",
        ...
        "Yes, there is a community section for discussions and sharing experiences.",
        "To report a problem, go to the support section and submit a ticket.",
        "You can reset your password by selecting 'Forgot Password' on the login screen.",
        "Yes, there are tutorials available in the help section of the app.",
        "You can provide feedback in the app's settings under 'Feedback'.",
        "Yes, your data is secure and encrypted within the app."
      ],
      'Rewards and Incentives': [
        "You can earn rewards for completing eco-friendly actions and participating in events.",
        "Referral bonuses are given when friends sign up using your referral code.",
        "Yes, we have seasonal promotions that offer extra rewards.",
        "You can track your rewards progress in the rewards section of your profile.",
        "Yes, you can donate your rewards to partnered environmental charities.",
        "Eligibility criteria include active participation in eco-friendly actions.",
        "To redeem rewards, visit the rewards section and follow the instructions.",
  ...
  const faqData = {
    ...
    'Rewards and Incentives': [
      ...
      'How can I track my rewards progress?',
