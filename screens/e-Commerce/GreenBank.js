          ...
          <Animated.View style={[styles.animatedContainer, screenStyle]}>
            ...
            <View style={styles.balanceContainer}>
              <Text style={styles.balance}>
                Balance: GCPs {balance.toFixed(2)}
              </Text>
              <Text style={styles.tokenBalance}>
                Bootstrap Tokens: {tokenBalance.toFixed(2)} pts
              </Text>
              <Text style={styles.totalPoints}>
                Total: GCPs {calculateTotalPoints().toFixed(2)}
              </Text>
            </View>
            ...
            <View style={styles.buttonContainer}>
              ...
              >
                {loading.deposit ? (
                  ...
                  <Text style={styles.buttonText}>Deposit Green Points</Text>
                )}
              </TouchableOpacity>
            ...
            <Text style={styles.footnote}>
              🌍 GreenBank - The Future of Eco-friendly Banking
            </Text>
          </Animated.View>
        )}
      </KeyboardAvoidingView>
