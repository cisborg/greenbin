...
const ProductDetail = () => {
  ...
  const reviewers = [
    ...
    },
    {
      name: "Jane Smith",
      stars: 4,
      message: "Good quality, but the zipper could be better.",
      date: new Date(),
    },
    {
      name: "Bob Johnson",
      stars: 3,
      message: "Average product, but decent value for the price.",
      date: new Date(),
    },
        ...
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
          ...
          <View style={styles.productInfoContainer}>
            ...
            <Text style={styles.productTitle}>
              Green Bin - 100% Recycled and Renewable Green Bins with Zippered
              Handles. Material: 100% Recycled Plastic, Dimensions: 30 x 30 x 30
              cm, Weight: 1.5 kg, Warranty: 2 years.
            </Text>
