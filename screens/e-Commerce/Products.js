    ...
    <View style={styles.storeHeaderContainer}>
      ...
      <View style={styles.storeInfoContainer}>
        ...
        <Text style={styles.storeDetails}>
          Total 707 products | {followers} followers
        </Text>
      ...
      <TouchableOpacity
        style={[
          styles.followButton,
          { backgroundColor: followText === "Connected" ? "green" : "#FF5722" },
        ]}
    ...
    >
      <TouchableOpacity style={styles.card}>
        ...
        <View style={styles.infoContainer}>
          ...
          {!item.originalPrice && (
            <Text style={styles.productPrice}>{item.price} GCP</Text>
          )}
          <Text style={styles.productBrand}>{item.brand}</Text>
          {item.isBrandOfficial && (
            <Text style={styles.officialBadge}>Brand Official</Text>
          )}
...
export default Products = () => {
  ...
  const renderFooter = () => {
    ...
    return (
      <ActivityIndicator size="large" color="#388e3c" style={{ margin: 10 }} />
    );
  };
          ...
          <View style={styles.sortFilterRow}>
            <View style={styles.pickerContainer}>
              <Picker
                ...
                style={{ height: 40, width: 150, borderRadius: 14 }}
              >
