...
const gamesData = [
  {
    ...
    description:
      "Participate in weekly challenges that encourage sustainable behaviors, like reducing plastic use or planting trees.",
    format: "Log activities and share photos to earn points and badges.",
    howToPlay:
      "Join the challenge, complete the tasks, and submit evidence through the app.",
  ...
  },
  {
    ...
    description:
      "Answer questions related to environmental issues and sustainability practices in a fun quiz format.",
    format: "Compete against friends or teams with leaderboards.",
    howToPlay:
      "Select a quiz, answer questions, and earn points for correct answers.",
  ...
  },
  {
    ...
    description:
      "Join virtual clean-ups and track your litter collection in your community.",
    format: "Share your results and earn rewards for participation.",
    howToPlay:
      "Collect litter, log your collection in the app, and share photos.",
  ...
  },
  {
    ...
    description:
      "Participate in local sports tournaments that promote environmental themes.",
    format: "Teams compete while raising awareness about conservation.",
    howToPlay:
      "Register your team, participate in matches, and enjoy eco-friendly events.",
  ...
  },
  {
    ...
    description:
      "Find and learn about local flora, fauna, and recycling bins in a fun scavenger hunt.",
  ...
  },
  {
    ...
    description:
      "Showcase your talents related to sustainability, like eco-friendly crafts or conservation-themed music.",
    format: "Vote for your favorite performances and win prizes.",
    howToPlay:
      "Submit your performance, get votes, and compete for recognition.",
  ...
  },
  {
    ...
    description:
      "Log your fitness miles and pledge to plant a tree for every milestone reached.",
    format:
      "Collaborate with local organizations to plant trees based on participation.",
    howToPlay:
      "Track your workouts in the app and achieve milestones for tree planting.",
  ...
  },
  {
    ...
    description:
      "Create art that promotes environmental themes and submit for a chance to win.",
  ...
  },
  {
    ...
    description:
      "Build and manage a sustainable city, making decisions that impact the environment.",
    format:
      "Compete to create the most eco-friendly city with educational content.",
    howToPlay:
      "Play the simulation, make eco-friendly choices, and earn rewards.",
  ...
  },
  {
    ...
    description:
      "Participate in sponsored events like park clean-ups and educational workshops.",
    format: "Sign up through the app to participate and earn rewards.",
    howToPlay:
      "Join events, complete tasks, and log your participation in the app.",
        ...
        <>
          <View style={styles.headerContainer}>
            ...
            <Text style={styles.header}>
              Discover New Games for Your Green Life!
            </Text>
          </View>
