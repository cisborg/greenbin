      ...
      <View style={styles.squadCard}>
        ...
        <View style={styles.squadDetails}>
          ...
          <Text
            style={[
              styles.status,
              item.status === "moderated" ? styles.moderated : styles.addPost,
            ]}
          >
            {item.status}
          </Text>
          ...
          <View style={styles.connectionsContainer}>
            ...
            <Text style={styles.connectionsCount}>
              {item.connections >= 1000
                ? `${(item.connections / 1000).toFixed(1)}k connectors`
                : `${item.connections} connectors`}
            </Text>
          </View>
          ...
          <TouchableOpacity
            style={[
              styles.joinButton,
              loadingState === "pending" ? styles.loadingButton : null,
            ]}
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.description}>
          Join our community squads to share your knowledge, learn from others,
